...
export class BuscadorPokemon {
  ...
  try {
    ...
    this.pokemon.set({
      ...
      type: datos.types.map((typeInfo: any) => typeInfo.type.name).join (', '), //EL MAP ME CONVIERTE EN TEXTO DE ACUERDO CON LA PROPIEDAD QUE YO LE PIDA EN ESTE CASO ES NAME//ME LLAMA LISTAS
    });
